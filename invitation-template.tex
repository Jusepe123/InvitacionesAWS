...
\definecolor{ClubNavy}{HTML}{002653}
\definecolor{DeepNavy}{HTML}{000B21}
\definecolor{ElectricBlue}{HTML}{021A46}
\definecolor{CyanAccent}{HTML}{00E7FB}
\definecolor{Ink}{HTML}{000B21}
\definecolor{Muted}{HTML}{002653}
\definecolor{PaperBlue}{HTML}{FFFFFF}
\definecolor{LineBlue}{HTML}{C6E6EB}

% Defaults make the shared template directly compilable.
\providecommand{\RecipientName}{INSTITUCIÓN DE EJEMPLO}
\providecommand{\RecipientRole}{A quien corresponda}
\providecommand{\Opening}{De nuestra mayor consideración:}
\providecommand{\ParticipationClosing}{Nos encantaría contar con la participación de su institución.}
...
\begin{tikzpicture}[remember picture,overlay,shift={(current page.south west)},x=1mm,y=1mm]
  ...
  \node[anchor=north west,inner sep=0,opacity=.96] at (13,289)
  ...
  % Recipient block.
  \node[anchor=north west,text width=174mm,text=Ink] at (18,214)
    {\fontsize{15}{17}\selectfont\bfseries \RecipientName};
  \node[anchor=north west,text width=174mm,text=Muted] at (18,204)
    {\fontsize{9}{11}\selectfont \RecipientRole};
  \draw[ElectricBlue,line width=.8pt] (18,195)--(52,195);

  % Main message.
  \node[anchor=north west,text width=174mm,align=justify,text=Ink] at (18,188)
    {\fontsize{10}{14}\selectfont
     \Opening

     \vspace{3mm}
     El \textbf{AWS Student Builder Group UPB Cbba} tiene el agrado de invitarle al
     \textbf{AWS Student Community Day (SCD) Bolivia 2026}, el primer evento internacional de la comunidad estudiantil de Amazon en Bolivia, será una jornada creada
     ...
     ideas en proyectos. \ParticipationClosing};
  ...
  \node[anchor=north,text=CyanAccent] at (167.5,59)
    {\fontsize{6.5}{8}\selectfont\bfseries PARA MÁS INFORMACIÓN};
  \node[anchor=north,text=white] at (167.5,51)
    {\href{https://bolivia.studentcommunity.day/}{\fontsize{6.5}{8}\selectfont\bfseries bolivia.studentcommunity.day}};
